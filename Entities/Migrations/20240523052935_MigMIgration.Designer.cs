...
namespace Entities.Migrations
{
    ...
    [Migration("20240523052935_MigMIgration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.IdentityEntity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.IdentityEntity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Patient", b =>
                {
                    ...
                    b.Property<string>("Gurdain")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GurdainOccupation")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<long?>("PermanentPincode")
                        .HasMaxLength(100)
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("PermanentStreetName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("PermanentTaluk")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("PermanentVillageTown")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("PresentDoorNo")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<long?>("PresentPincode")
                        .HasMaxLength(100)
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("PresentStreetName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("PresentTaluk")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("PresentVillageTown")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasData(
                        new
                        {
                            PatientId = "c03bbe45-9aeb-4d24-99e0-4743016ffce9",
                        ...
                        new
                        {
                            PatientId = "c3abddbd-cf50-41d2-b6c4-cc7d5a750928",
                        ...
                        new
                        {
                            PatientId = "c6d50a47-f7e6-4482-8be0-4ddfc057fa6e",
                        ...
                        new
                        {
                            PatientId = "d15c6d9f-70b4-48c5-afd3-e71261f1a9be",
                        ...
                        new
                        {
                            PatientId = "89e5f445-d89f-4e12-94e0-5ad5b235d704",
                        ...
                        new
                        {
                            PatientId = "2a6d3738-9def-43ac-9279-0310edc7ceca",
                            DateOfBirth = new DateTime(1988, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mlingfoot5@netvibes.com",
                            Gender = "Male",
                            PatientName = "Mitchael"
                        },
                        new
                        {
                            PatientId = "29339209-63f5-492f-8459-754943c74abf",
                        ...
                        new
                        {
                            PatientId = "ac660a73-b0b7-4340-abc1-a914257a6189",
                        ...
                        new
                        {
                            PatientId = "012107df-862f-4f16-ba94-e5c16886f005",
                            DateOfBirth = new DateTime(1990, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "hmosco8@tripod.com",
                            Gender = "Male",
                            PatientName = "Hansiain"
                        },
                        new
                        {
                            PatientId = "cb035f22-e7cf-4907-bd07-91cfee5240f3",
                        ...
                        new
                        {
                            PatientId = "28d11936-9466-4a4b-b9c5-2f0a8e0cbde9",
                        ...
                        new
                        {
                            PatientId = "a3b9833b-8a4d-43e9-8690-61e08df81a9a",
            ...
            modelBuilder.Entity("Entities.Patient", b =>
                {
                    b.HasOne("Entities.Country", "CountryName")
                        .WithMany("Patients")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Entities.IdentityEntity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Entities.IdentityEntity.User", null)
                        .WithMany()
